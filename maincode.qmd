...
combined_data |>
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = str_wrap("Average attendance of NBA and WNBA games by team during the 2024 season", width = 60), x = "Team", y = "Average Attendance", fill = "League")
...
nba_data_2024 |>
  ...
  scale_y_log10() +
  theme_minimal() +
  labs(title = str_wrap("2024 Season Payroll vs. Revenue of NBA Teams", width = 60), x = "Team", y = "Millions of Dollars", fill = " ")
...
wnba_data_2024 |>
  ...
  scale_y_log10() +
  theme_minimal() +
  labs(title = str_wrap("2024 Season Payroll vs. Revenue of WNBA Teams", width = 60), x = "Team", y = "Millions of Dollars", fill = " ", line = "League Revenue")
...
`league,share_of_league_revenue` |>
  ...
  geom_col(col = "white") +
  theme_minimal() +
  labs(title = str_wrap("Estimated Share of League Revenue in Annual Wages of Players in the NBA and WNBA in 2024", width = 60), x = "League", y = "Percent of Revenue")
...
combined_data |>
  ...
  theme_minimal() +
  labs(title = str_wrap("Estimated Share of League Revenue in Annual Wages of Players in the NBA and WNBA in 2024", width = 60), x = "League", y = "Log Scale in $M", fill = " ")
...
combined_data |>
  ...
  theme_minimal() +
  labs(title = str_wrap("Estimated Share of League Revenue in Annual Wages of Players in NBA and WNBA in 2024", width = 60), x = "Type", y = "Millions of Dollars")
...
highest.paid.players |>
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = str_wrap("Highest Paid Players in NBA and WNBA in 2024", width = 60), x = "Player", y = "Salary", fill = "League")
